...
from rmp2.envs import Xarm7Env
from rmp2.utils.env_wrappers import Xarm7FullRMPWrapper
...
env_wrapper = Xarm7FullRMPWrapper(dtype=dtype)
rmp_graph = RobotRMPGraph(robot_name="xarm7", dtype=dtype)
